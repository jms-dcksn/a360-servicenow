...
public final class DeleteAttachmentCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DeleteAttachmentCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    DeleteAttachment command = new DeleteAttachment();
    ...
    try {
      command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("sys_id"));Optional<Value> result = Optional.empty();
